...
> **Tip:** JMDT is an ERC-20 compatible token. Ensure your wallet supports EVM networks and that you are sending to the correct network address.
...
Once you have JMDT, here is what you can do with it:
...
For full token economics, see [Tokenomics →](/docs/tokenomics).
...
- [Tokenomics →](/docs/tokenomics) — Full token supply, allocation, and vesting details
- [Use Cases →](/docs/use-cases) — How JMDT powers real-world applications
- [Running a Node →](/docs/running-a-node) — Set up a JMDN node to participate in the network
